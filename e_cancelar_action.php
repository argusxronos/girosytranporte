...
<head>
    ...
    <meta name="author" content="Design: Wolfgang (www.1-2-3-4.info) / Modified: Jonatan Rivera C." />
    ...
    <title>.::TC Anular Liquidaci&oacute;n::.</title>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/e_cancelar_action_content.php'); ?>
