...
<div class="main-content">
	...
	<!-- Pagetitle -->
	<h1 class="pagetitle">Modificar Giro</h1>
    <?php 
	if (!isset($_GET['ID']))
	{
?>
	...
	<div class="column1-unit">
	  ...
	  <?php echo '<h3>'.date("l j \d\e F, Y, h:i A").'</h3>'; ?>
		<form method="get" action="g_modificar.php" name="buscar_giro" >
			...
			if (isset($_GET['btn_buscar']) && count($Giros_Array) > 0)
			{
				...
				for ($fila = 0; $fila < count($Giros_Array); $fila++)
				{
					...
					echo "<tr>";
							...
							if ($estado == 'NO')
							{
								echo '<td style="text-align:center;"><a href="g_modificar.php?ID='.$id.'" ><img src="./img/operacion/Symbol-Update.png" width="24" height="24" title="Modificar Giro." /></a></td>';
							}
					echo "</tr>";
				}
...
?>
	...
	<div class="column1-unit">
		...
		<form action="g_modificar_action.php?insert" method="post" name="entrega_form" target="_self">
			<table width="100%" border="0">
              <tr>
				<th>Documento :</th>
				<td colspan="3">
                	<span><?php echo $Giro_Array[0][8]; ?></span>
                - 
                <input type="text" value="<?php echo $Giro_Array[0][9]; ?>" name="txt_numero" class="field" style="width:120px;" title="N&uacute;mero de la Boleta." tabindex="1" onkeypress="return handleEnter(this, event)" onkeyup="extractNumber(this,0,false);" autocomplete="off" onfocus="this.select();" /></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td  colspan="3"><input type="hidden" id="txt_consig_hidden" name="txt_consig_ID" value="<?php echo $Giro_Array[0][4]; ?>" />
					<input type="text" value="<?php echo utf8_encode($Giro_Array[0][5]); ?>" name="txt_consig" class="field" style="width:455px;text-transform:uppercase;" title="Apellidos del Consignatario." tabindex="3" onkeypress="return acceptletras2(this, event)" autocomplete="off" onfocus="this.select();" /></td>
			  </tr>
			  <tr>
				<th colspan="4" style="height:5px;"></th>
			  </tr>
			  <tr>
				...
				<td colspan="4"><input type="text" name="txt_observ" onkeypress="return handleEnter(this,event);" onfocus="this.select()" style="width:98%;text-transform:uppercase;" tabindex="4" /></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				<th colspan="4" scope="row" style="text-align:center;"><span>
				  ...
				  <input type="button" name="btn_regresar" id="btn_regresar" class="button" value="Regresar" tabindex="6" onclick="document.location.href='g_modificar.php';" />
				</span></th>
			  </tr>
			</table>
		</form>
