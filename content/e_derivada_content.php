            ...
            <table border="0">
			  <tr>
				...
				<td colspan="3" style="width:110px;">
					<select name="cmb_usuario" id="cmb_usuario" class="combo" tabindex="3" onkeypress="return handleEnter(this, event)" title="Tipo de Documento a emitir." style="width:340px;" >
			  ...
			  <td colspan="2" id="num_documento2"><input name="txt_serie" id="txt_serie" type="text"  readonly="readonly" 
				title="Numero de Serie" style="width:90px; font-size:140%; color:#FF0000; font-weight:bold; text-align:center;" /> 
				    - 
				    <input name="txt_numero" id="txt_numero" type="text" class="field" tabindex="5" title="Número del Documento." style="font-size:140%; color:#FF0000; font-weight:bold; text-align:center;" onkeypress="return handleEnter(this,event);" onkeyup="extractNumber(this,0,false);" onfocus="this.select()" /></td>
			  </tr>
            </table>
		  </div>
          <table>
