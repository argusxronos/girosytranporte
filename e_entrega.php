...
<head>
  ...
  <title>.::Entregar Encomienda::.</title>
...
<body <?php if (!isset($_GET['ID'])) echo 'OnLoad="document.buscar_encomienda.txt_consignatario.focus();"';
elseif(isset($_GET['ID'])) echo 'OnLoad="if(document.entrega_form.txt_clave) document.entrega_form.txt_clave.focus();"'; if(isset($_SESSION['IS_LOGGED'])) echo 'onbeforeunload="ConfirmClose()" onunload="HandleOnClose()"'; ?>>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/e_entrega_content.php'); ?>
