...
<div class="buttom_doc2" style="text-align:left;">
  <table width="1323" style="width=1250; border=0; font-size:16px;" >
    <tr>
...
<div class="content"  style="text-align:left; letter-spacing: 1px; font-size:13px; ">
    <table width="1250" border="0">
      ...
      <tr>
        ...
        <td style="width:200px;"><div align="center"><?php echo $fecha; ?></div></td>
      </tr>
      <tr>
        <td style="height:25px; padding-left:40px;"><?php echo $oficina_destino_nombre; ?></td>
        <td width="22%"><div align="center"><?php echo $hora; ?></div></td>
      </tr>
      <tr>
    ...
    <table width="1250" height="20" border="0">
