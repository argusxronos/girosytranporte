...
$piso=$_GET[p];
$ruta=$_GET[ruta];
$direccion="asientos=$nro_asiento&p=$piso&salida=$id_salida&destino=$destino_salida&fecha=$fecha_salida&hora=$hora_salida&ruta=$ruta&bus=$id_bus";
//$direccion=$_GET[];
?>
	...
	<form id='venta_form' name="venta_form" method='post' action='p_form_ventas_action.php?insertventa'>
		...
		<table>
			...
			<tr>
				<th>Destino:</th>			
				<td colspan="5">
					<input name="txt_destino" id="txt_destino" onfocus="copiarDatos()" type="text" readonly value="<?php echo $Rutas_Array[0][1];?>" title="Destino a viajar." style="width:500px; text-align:center;  font-size:110%; font-weight:bold;text-transform:uppercase;">
				</td>
			</tr>
			<tr>
				<th>Importe:</th>
			...
			<tr id="DivDocumento">
				<th>DSCTO</th>
				<td>				
					<input name="txt_descuento" id="txt_descuento" type="text" value="" onkeypress="return handleEnter(this,event);"  ONKEYUP="extractNumber(this,2,false); document.venta_form.txt_importe_pagar.value = document.venta_form.txt_importe.value - document.venta_form.txt_descuento.value;document.venta_form.txt_importe_pagar_letras.value= covertirNumLetras(document.venta_form.txt_importe_pagar.value, 1);document.form_ventas_pasajes.txt_importe_total.value = document.venta_form.txt_importe_pagar.value;" title="Descuento" style="width:110px; text-align:center; font-size:110%; font-weight:bold; text-transform:uppercase;">
				</td>
				<th>Sub Rutas</th>	
				<td>
					<select name="cmb_ruta" class="combo" title="Sub Rutas de salida" style="font-size:110%; width:250px; font-weight:bold;" onchange="precios();" onfocus="copiarDatos()">
						<?php																																									
			...
			<input type="hidden" name="txt_boleto" id="txt_boleto"/>
			<input type="hidden" name="txt_serie_boleto" id="txt_serie_boleto"/>
			<input type="hidden" name="txt_piso" id="txt_piso"/>
			<input type="hidden" name="txt_asiento" id="txt_asiento"/>
			<input type="hidden" name="txt_importe_final" id="txt_importe_final"/>	
			...
			<tr>
				<td colspan="6" style="text-align:center; font-size:120%;">
					<input name="btn_guardar_venta" id="btn_guardar_venta" type="submit" class="button" value="Grabar Venta" onclick="this.disabled = 'true'; this.value = 'Enviando...'; document.giro_form.submit();" />
				</td>
			</tr>
