...
<head>
    ...
    <title>.::Cancelar Envio Enc.::.</title>
...
<body <?php if (!isset($_GET['btn_buscar'])) echo 'OnLoad="document.buscar_liquidacion.txt_num_liquidacion.focus();"'; if(isset($_SESSION['IS_LOGGED'])) echo 'onbeforeunload="ConfirmClose()" onunload="HandleOnClose()"'; ?>>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/e_cancelar_content.php'); ?>
