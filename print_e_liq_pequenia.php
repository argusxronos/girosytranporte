  ...
  <div class="content"  style="text-align:left;">
	...
	if (count($Mov_Array_List) > 0)
	{
		...
		for ($fila = 0; $fila < count($Mov_Array_List); $fila++)
		{
			...
			{
				echo '<tr>';
					echo '<td colspan="6" Rowspan= "1" style="text-align:center; font-weight:bold; padding-top:1px; height:20px; letter-spacing:5px;"><span>'.OficinaByID($oficina).'</span></td>';
				echo '</tr>';
...
<div class="buttom_doc" style="text-align:left; letter-spacing: 1px; font-size:16px; ">
  <table width="1080" height="203" border="0">
    <tr>
      <td style="width:90px; text-align:right;">
      
     <table width="1080" border="0">
        <tr>
          <td style="width:170px; padding-left:100px; height:37px; vertical-align:top"><table width="1242" border="0">
                <tr>
                  <td width="1149" style="width:90px; text-align:right;">
                  
                  <table width="1260" border="0">
                      <tr>
                        <td style="width:170px; padding-left:100px; height:37px; vertical-align:top"><div align="left"><?php echo $total_guias; ?></div></td>
                        <td style="width:280px;">&nbsp;</td>
                        <td style="width:90px; text-align:right;"><?php echo $total_carrera ; ?></td>
                        <td style="width:90px; text-align:right;"><?php echo $total_importe; ?></td>
                      </tr>
                      <tr>
                        <td style=" height:27px;">&nbsp;</td>
                        <td style="padding-left:200px;text-align:center;"><?php echo $comision.' %'; ?></td>
                        <td style="text-align:right">0.00</td>
                        <td style="text-align:right"><?php echo round(($total_importe - $saldo_importe),2); ?></td>
                      </tr>
                      <tr>
                        <td style=" height:27px;">&nbsp;</td>
                        <td style="vertical-align:top; padding-left:40px;"><div align="left"><?php echo $nombre_usuario; ?></div></td>
                        <td style="text-align:right"><?php echo $saldo_carrera; ?></td>
                        <td style="text-align:right"><?php echo $saldo_importe; ?></td>
                      </tr>
                  </table></td>
...
<table width="1348" height="150" border="0">
<tr>
        <td colspan="3" style="height:80px; vertical-align:bottom; text-align:right; padding-right:100px; padding-bottom:15px;"><div align="right"><?php echo $num_doc; ?></div></td>
    </tr>
      <tr>
        <td width="397" style="width:350px;">&nbsp;</td>
        <td width="420" style="width:350px;letter-spacing:4px; padding-left:100px;"><div align="center"></div>
        <?php echo $oficina_origen_nombre; ?></td>
        <td width="431" style="width:400px; text-align:right;"><?php echo $fecha; ?></td>
      </tr>
      <tr>
        <td height="16" colspan="3" style="">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2" style="height:27px; padding-left:100px; letter-spacing:4px;"><div align="left"><?php echo $oficina_destino_nombre; ?></div></td>
        <td style="width:400px; text-align:right;"><?php echo $hora; ?></td>
      </tr>
      <tr>
        <td colspan="2" style="height:27px; padding-left:100px; letter-spacing:4px;"><div align="left"><?php echo $chofer; ?></div></td>
        <td style="width:215px; text-align:right;"><?php echo $pullman; ?></td>
      </tr>
  </table>
<table width="1350" height="20" border="0">
