...
<body <?php if(!isset($_GET['ID'])) echo 'OnLoad="document.buscar_giro.txt_consignatario.focus();"'; else echo 'OnLoad="document.change_form.txt_clave.focus();"'; if(isset($_SESSION['IS_LOGGED'])) echo 'onbeforeunload="ConfirmClose()" onunload="HandleOnClose()"'; ?>>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/g_cambiar_clave_content.php'); ?>
