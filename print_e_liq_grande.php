<?PHP
	...
	$db_giro->query("SELECT 
					...
					, LEFT(IF(`CONSIG`.`per_tipo` = 'PERSONA', `CONSIG`.`per_nombre`, `CONSIG`.`per_razon_social`), 29) AS `CONSIGNATARIO`
...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <title>.::Liquidaci&oacute;n Encomienda Grande::.</title>
	<!-- Hoja de Estilos -->
	<link rel="stylesheet" type="text/css" media="screen,projection,print" href="./css/liq_grande.css" />
	<!-- Icono -->
...
<!--[if (IE 7) | (IE 8)]>
<div class="buttom_doc2" style="text-align:left;">
  <table border="0">
    <tr>
      <td style="width:160px; padding-left:100px; height:27px;"><?php echo $total_guias; ?></td>
    ...
    <tr>
      ...
      <td style="padding-left:220px;"><?php echo $comision .' %'; ?></td>
      <td style="text-align:right">0.00</td>
      <td style="text-align:right"><?php echo round($total_importe - $saldo_importe,2); ?></td>
    </tr>
    <tr>
      <td style=" height:27px;">&nbsp;</td>
      <td style="padding-left:50px;"><?php echo $nombre_usuario; ?></td>
...
<div class="content"  style="text-align:left;">
  <div class="content"  style="text-align:left;">
    <table width="100%" border="0">
      <tr>
        <td colspan="2" style="height:100px; vertical-align:bottom; text-align:right; padding-right:250px;"><?php echo $num_doc; ?></td>
      </tr>
      <tr>
        <td style="height:27px; width:350px;letter-spacing:4px;"><?php echo $oficina_origen_nombre; ?></td>
        <td style="width:200px;"><?php echo $fecha; ?></td>
      </tr>
      <tr>
        <td style="height:25px; padding-left:40px;"><?php echo $oficina_destino_nombre; ?></td>
        <td width="22%"><?php echo $hora; ?></td>
      </tr>
      <tr>
        <td style="height:25px; padding-left:40px;"><?php echo $chofer; ?></td>
	...
	if (count($Mov_Array_List) > 0)
	{
		...
		for ($fila = 0; $fila < count($Mov_Array_List); $fila ++)
		{
			...
			{
				echo '<tr>';
					echo '<td colspan="6" style="text-align:center; font-weight:bold; height:20px; letter-spacing:5px;"><span>'.OficinaByID($oficina).'</span></td>';
				echo '</tr>';
			...
			echo '<tr id="div_tr_'.$id_movimiento.$num_item.'">';
				...
				echo '<td style="text-align:left; padding-left:5px;">'.utf8_encode($descripcion).'</td>';
				if ($carrera == '0.00')
				{
...
<![endif]-->
<!--[if FF ]>-->
<div class="buttom_doc2" style="text-align:left; text-align:left; letter-spacing: 1px; font-size:16px;"> 
  <table width="1250" border="0">
    <tr>
      <td style="width:160px; padding-left:100px; height:37px; vertical-align:top"><div align="left"><?php echo $total_guias; ?></div></td>
      <td style="width:320px;">&nbsp;</td>
      <td style="width:90px; text-align:right;"><?php echo $total_carrera ; ?></td>
      <td style="width:90px; text-align:right;"><?php echo $total_importe; ?></td>
    </tr> 
...
<div class="content"  style="text-align:left; text-align:left; letter-spacing: 0px; font-size:13px; ">
  <div class="content"  style="text-align:left; text-align:left; letter-spacing: 0px; font-size:13px; ">
    <table width="1246" border="0">
      <tr>
        ...
        <td colspan="2" style="height:105px; vertical-align:bottom; text-align:right; padding-right:250px;"><?php echo $num_doc; ?></td>
      </tr>
      <tr>
        <td style="height:27px; width:350px;letter-spacing:4px;"><div align="center"><?php echo $oficina_origen_nombre; ?></div></td>
        <td style="width:200px;"><?php echo $fecha; ?></td>
      </tr>
      <tr>
        <td style="height:25px; padding-left:150px;"><?php echo $oficina_destino_nombre; ?></td>
        <td width="22%"><?php echo $hora; ?></td>
      </tr>
      <tr>
        <td style="height:25px; padding-left:150px;"><?php echo $chofer; ?></td>
        <td width="22%"><?php echo $pullman; ?></td>
      </tr>
    </table>
    <table width="1250" height="24" border="0">
      <tr style="height:90px;">
		<td width="126" style="text-align:left; width:100px; margin-top:2px; letter-spacing:4px;">&nbsp;</td>
        <td width="427" style="width:340px;text-align:left; letter-spacing:4px;">&nbsp;</td>
        <td width="431" style="text-align:left;width:335px; letter-spacing:4px;">&nbsp;</td>
        <td width="91" style="text-align:right; width:80px; letter-spacing:4px;">&nbsp;</td>
        <td width="153" style="text-align:right; width:120px; letter-spacing:4px;">&nbsp;</td>
