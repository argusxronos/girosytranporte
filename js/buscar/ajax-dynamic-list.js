...
************************************************************************************************************/
	...
	var ajax_list_externalFile = 'js/buscar/ajax-list-customers.php';	// Path to external file
	var minimumLettersBeforeLookup = 7;	// Number of letters entered before a lookup is performed.
	...
	function ajax_showOptions(inputObj,paramToExternalFile,e)
	{
		...
		if(ajax_list_cachedLists[paramToExternalFile][inputObj.value.toLowerCase()]){
			...
			var url = ajax_list_externalFile + '?' + paramToExternalFile + '=1&letters=' + inputObj.value.replace(" ","+") + '&r=' + parseInt(Math.random());
