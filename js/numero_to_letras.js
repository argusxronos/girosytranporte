...
/*CONVERTIR NUMEROS A LETRAS INICIO*/
...
function covertirNumLetras(number, tipo_moneda)
{
    ...
    //Mind Mod
    number=cent[0];
	// variable para los millones
	var millions_final_string = "";
	// variable para los cientos
   ...
   //document.venta_form.txt_importe_letras.value = covertirNumLetras(document.venta_form.txt_importe.value);
   
}

/*cONVERTIR NUMEROS A LETRAS FIN*/
