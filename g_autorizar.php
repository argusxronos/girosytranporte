...
<body OnLoad="document.buscar_giro.txt_consignatario.focus();" <?php if(isset($_SESSION['IS_LOGGED'])) echo 'onbeforeunload="ConfirmClose()" onunload="HandleOnClose()"'; ?>>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/g_autorizar_content.php'); ?>
