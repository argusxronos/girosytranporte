...
<head>
    ...
    <script type="text/javascript" src="js/ajax-e-recepcion.js"></script>
    <script languaje="javascript">
		function reprint_liquidacion (url, id)
		{
           window.open(url+'?ID='+id,'BOLETA','scrollbars=no, resizable=yes, width=1000, height=500, status=no, location=no, toolbar=no')
		}
    </script>    
</head>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/rpt_e_liquidacion_content.php'); ?>
