...
<body <?php if(!isset($_GET['ID'])) echo 'OnLoad="document.buscar_giro.txt_serie_doc.focus();"';  if(isset($_SESSION['IS_LOGGED'])) echo 'onbeforeunload="ConfirmClose()" onunload="HandleOnClose()"'; ?>>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/g_modificar_destino_content.php'); ?>
