...
<head>
  ...
  <title>.::Ingresar Nuevos Buses::.</title>
...
<body OnLoad="document.bus_search_form.buscar.focus();" <?php if(isset($_SESSION['IS_LOGGED'])) echo 'onbeforeunload="ConfirmClose()" onunload="HandleOnClose()"'; ?>>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      include_once('content/p_bus_content.php')?>
