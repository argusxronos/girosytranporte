				...
				<table>
					<tr>
						...
						<td colspan="2" style="text-align:right;">									
							<input id='nro_serie' type='text' name='nro_serie' tabindex="1" value="" title="Número de Serie." onkeypress="return handleEnter(this,event);" onkeyup="extractNumber(this,0,false);" style="width:100px; text-align:center; color:#FF0000; font-size:110%; font-weight:bold;" autocomplete="off"> - 
							<input id='nro_boleto' type='text' name='nro_boleto' tabindex="2" value="" title="Número de Boleto." onkeypress="return handleEnter(this,event);" onkeyup="extractNumber(this,0,false);" style="width:100px; text-align:center; color:#FF0000; font-size:110%; font-weight:bold;" autocomplete="off">
    ...
    ?>		     
	    ...
	    function validacion(){	    
		    if (document.resultado_pasaje.nro_guia.value.length==0){
		       alert("Tiene que ingresar el numero de Vale")
