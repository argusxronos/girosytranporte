...
<head>
  ...
  <!--Para mostrar los destinos de las oficinas-->
  <script type="text/javascript" src="js/ajax-get-oficinas.js"></script>
  <script type="text/javascript" src="js/ajax-get-dato-detino.js"></script>
  <!-- Script para usar Enter en vez de TAB -->
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      include_once('content/p_copiar_salida_content.php')?>
