<?php
// FUNCION PARA OBTENER LOS NOMBRES DE LAS OFICINAS POR SU ID
	...
	// FUNCION PARA OBTENER LOS CodigoUsuario por la ID Usuario
	...
	// FUNCION PARA OBTENER LOS Nombres por la ID Usuario
