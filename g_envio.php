...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./css/buscar_persona.css"/>
  <!-- Icono -->
  ...
  <script type="text/javascript" src="ajax/ajax_tipo_doc.js"></script>
  ...
  <!-- Script para validar el navegador SI SE RESPETA LOS ESTANDARES W3C NO SERA NECESARIO USAR ESTE SCRIPT-->
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/g_envio_content.php'); ?>
