...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="screen,projection,print" href="css/imprimir_vale.css" />
  
  <title>.::TC - Reservas Pagadas :.</title>
...
<body   <?php if(isset($_SESSION['IS_LOGGED'])) echo 'onbeforeunload="ConfirmClose()" onunload="HandleOnClose()"'; ?>>
  ...
  <!-- START B. MAIN -->
    <div class="main">
      ...
      <?php include_once('vales/v_pasajes_pagados_action_content.php'); ?>
