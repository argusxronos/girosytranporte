...
<head>
  ...
  <title>.::TC - Enviar Encomienda::.</title>
  ...
  <!-- Script para Separar los Apellidos y Nombres -->
  <script language="javascript" src="js/ruc_validaciones.js"> 
  </script>
  <!-- Start:Ajax para Obtener series y Numeros de los Documentos -->
  <script type="text/javascript" src="js/ajax-get-documento.js">
  </script>
  <!-- End:Ajax para Obtener series y Numeros de los Documentos -->
  
  <!-- Start:Ajax para Obtener series y Numeros de los Documentos -->
  <script type="text/javascript" src="js/ajax-insert-temp.js">
  </script>
  <!-- End:Ajax para Obtener series y Numeros de los Documentos -->
  
  <!-- Start:Ajax para Obtener series y Numeros de los Documentos -->
  <script type="text/javascript" src="js/buscar/ajax.js"></script>
  <script type="text/javascript" src="js/buscar/ajax-e-persona-list.js"></script>
  <script type="text/javascript" src="js/buscar/ajax-get-Client.js"></script>
...
<body OnLoad="document.encomienda_form.txt_fecha.focus();" <?php if(isset($_SESSION['IS_LOGGED'])) echo 'onbeforeunload="ConfirmClose()" onunload="HandleOnClose()"'; ?>>
  ...
  <div class="page-container">
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <?php include_once('content/e_derivada_content.php'); ?>
